...
const dissap = document.querySelector("#nachalo");
dissap.addEventListener('click', function () {
  begin.style.display = "none";
  begin1.style.display = "block";
})
const begin1 = document.querySelector("#begin1");
const dissap1 = document.querySelector("#nachalo1");
dissap1.addEventListener('click', function () {
  begin1.style.display = "none";
  begin2.style.display = "block";
})
const begin3 = document.querySelector("#begin3");
const begin2 = document.querySelector("#begin2");
const itcss = document.querySelector(".itcss");
const dissap2 = document.querySelector("#nachalo2");
dissap2.addEventListener('click', function () {
  begin2.style.display = "none";
  begin3.style.display = "none";
  itcss.style.display = "block";
})
